...
struct pwm_vibrator *avrman_vibrator;

int pwm_vibrator_play_effect(struct input_dev *dev, void *data,
				    struct ff_effect *effect)
{
	//struct pwm_vibrator *vibrator = input_get_drvdata(input);
	struct pwm_vibrator *vibrator = avrman_vibrator;
